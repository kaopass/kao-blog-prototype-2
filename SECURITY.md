...
Resources:
- [Web Security Guide - SQL Injection](http://guides.rubyonrails.org/security.html#sql-injection)
...
Resources:
- [Web Security Guide - Sessions](http://guides.rubyonrails.org/security.html#sessions)
...
Resources:
- [Web Security Guide - XSS](http://guides.rubyonrails.org/security.html#cross-site-scripting-xss)
- [OWASP XSS Filter Evasion Cheat Sheet](https://www.owasp.org/index.php/XSS_Filter_Evasion_Cheat_Sheet)
- [OWASP Web Cheatsheet - Cross-site Scripting (XSS)](https://www.owasp.org/index.php/Ruby_on_Rails_Cheatsheet#Cross-site_Scripting_.28XSS.29)
...
Resources:
- [Web Security Guide - File Uploads and Downloads](http://guides.rubyonrails.org/security.html#file-uploads)
...
Resources:
- [Web Security Guide - CSRF](http://guides.rubyonrails.org/security.html#cross-site-request-forgery-csrf)
...
Resources:
- [OWASP Web Cheatsheet - Redirects and Forwards (URL validation)](https://www.owasp.org/index.php/Ruby_on_Rails_Cheatsheet#Redirects_and_Forwards)
...
- [Web Security Guide](http://guides.rubyonrails.org/security.html)
...
- [Web Security 17-Item Checklist](https://www.engineyard.com/blog/ruby-on-rails-security-checklist)
